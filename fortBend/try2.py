...
with pdfplumber.open("./scan_281lm_amazon_fbctra_(9)__september_19_(ag).pdf") as pdf:
    for x, text in enumerate(pdf.pages):
        ...
        all_table = re.findall(r'S\d*..\W\d*.\w*\W\d*.\w*.\w*.\D*\d.\w*.\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s\W\d\W\d*|[a-zA-Z0-9]*\W*\d{5}[\W_]*[\d|\w]\/[a-zA-Z0-9]*\/[\d|\w]{2}[a-zA-Z0-9 .<_\n-]*\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*[$|S][\d|\w]*[\W]*[\w\d]*\n', page_content)
        ...
        if len(all_table) > 0:
            for i in all_table:
                # print(i)
                license_plate = re.findall(r'S\d*\W*\d*\W\D\w*\W(\d*)\W\w*\W\w*\W*\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*|S\d*..\W\d*.\w*\W\d*(.\w*).\w*.\D*\d.\w*.\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s\W\d\W\d*|[a-zA-Z0-9]*\W*\d{5}[\W_]*([\d|\w]\/[a-zA-Z0-9]*)\/[\d|\w]{2}[a-zA-Z0-9 .<_\n-]*\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*[$|S][\d|\w]*[\W]*[\w\d]*\n', i)
                state = re.findall(r'S\d*..\W\d*.(.\w*)\W\d*.\w*.\w*.\D*\d.\w*.\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s\W\d\W\d*|[a-zA-Z0-9]*\W*\d{5}[\W_]*[\d|\w]\/[a-zA-Z0-9]*\/([\d|\w]{2})[a-zA-Z0-9 .<_\n-]*\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*[$|S][\d|\w]*[\W]*[\w\d]*\n', i)
                trxn_date_time = re.findall(r'S\d*\W\d*.\w*\W\d*.\w*.\w*.\D*\d.\w*.\D*\d*\W(\d*\W\d*\W\d*\W\d*\W\d*\W\d*)\s\W\d\W\d*', i)
                exit_lane = re.findall(r'S\d*\W*\d*\W\D\w*\W\d*\W(\w*\W\w*\W*\D*\d*)\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*|\w{13}\W\d*\W\d*\W\d*\W\w*\W(\w*\W\w*\W\d*)\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*|S\d*..\W\d*.\w*\W\d*.\w*.(\w*.\D*\d.\w*.\D*\d*)\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s\W\d\W\d*|[a-zA-Z0-9]*\W*\d{5}[\W_]*[\d|\w]\/[a-zA-Z0-9]*\/[\d|\w]{2}([a-zA-Z0-9 .<_\n-]*)\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*[$|S][\d|\w]*[\W]*[\w\d]*\n', i)
                invoice = re.findall(r'(S\d*..\W\d*).\w*\W\d*.\w*.\w*.\D*\d.\w*.\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s\W\d\W\d*|([a-zA-Z0-9]*\W*\d{5})[\W_]*[\d|\w]\/[a-zA-Z0-9]*\/[\d|\w]{2}[a-zA-Z0-9 .<_\n-]*\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*[$|S][\d|\w]*[\W]*[\w\d]*\n', i)
                amount_due = re.findall(r'S\d*\W\d*.\w*\W\d*.\w*.\w*.\D*\d.\w*.\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\s(\W\d\W\d*)|[a-zA-Z0-9]*\W*\d{5}[\W_]*[\d|\w]\/[a-zA-Z0-9]*\/[\d|\w]{2}[a-zA-Z0-9 .<_\n-]*\d{2}\/\d{2}\/[\w0-9 -]*[:|;|.][\d|\w]{2}[:|;|.][\d|\w]{2}[\W]*([$|S][\d|\w]*[\W]*[\w\d]*\n)', i)
