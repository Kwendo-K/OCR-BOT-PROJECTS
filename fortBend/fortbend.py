...
with pdfplumber.open("./scan_281lm_amazon_fbctra_(9)__september_19_(ag).pdf") as pdf:
    for x, text in enumerate(pdf.pages):
        ...
        if len(all_table) > 0:
            for i in all_table:
                # print(i)
                license_plate = re.findall(r'S\d*\W*\d*\W\D\w*\W(\d*)\W\w*\W\w*\W*\D*\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*|\w{13}\W\d*\W(\d*\W\d*\W\w*)\W\w*\W\w*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*', i)
                ...
                exit_lane = re.findall(r'S\d*\W*\d*\W\D\w*\W\d*\W(\w*\W\w*\W*\D*\d*)\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*|\w{13}\W\d*\W\d*\W\d*\W\w*\W(\w*\W\w*\W\d*)\W\d*\W\d*\W\d*\W\d*\W\d*\W\d*\W\W\d*\W\d*', i)
